...
class PCGrad():
    def __init__(self, cfg, model, optimizer, reduction='mean',FP16_ENABLED=False,Conflict='ALL'):
    ...
    def pc_backward(self, objectives, grads, shapes, has_grads):
        '''
    ...
    def _pack_grad(self, objectives):
        ...
        for i in objectives:
            ...
            if self.fp16:
                with amp.scale_loss(obj, self._optim) as scaled_loss:
